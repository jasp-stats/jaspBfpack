...
test_that("BFs: Standard Hypotheses table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-0.0182577435245936, -0.0163563443359137, "", "sales_with_adverts",
                                      "", -0.558529749390423, 1.66120515920567, "airplay_with_adverts",
                                      "", -1.01334973677073, 2.46035907481941, "attract_with_adverts",
                                      -0.015706519828287, -0.0142524221677479, "", "airplay_with_sales",
                                      -0.0773066533681776, -0.0542570582453729, "", "attract_with_sales",
                                      -0.517548237702721, -0.148853447656929, "", "attract_with_airplay"
                                 ))
})
